...
Given seat "SEAT-42A" for event "EVT-100" is verified as ACTIVE by the Catalog Context
And seat "SEAT-42A" is not currently locked in Redis
When buyer "USR-101" submits a reservation request for "SEAT-42A"
Then the system acquires a temporary distributed lock (Redlock) on "SEAT-42A" with a 5-minute TTL
